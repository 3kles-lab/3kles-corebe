...
export class GenericMetric implements IMetricRegistry<Registry> {
    ...
    public collect(): (req: any, res: any, next: any) => void | Promise<void> {
        ...
        const httpRequestDurationHistogram = this.register.getSingleMetric(
            'http_requests_duration_histogram_seconds',
        ) as Histogram;
